...
def az_export_prices_list_to_csv(csv_prices_output_filename, csv_currencies_output_filename, prices_list={}, is_silent_enabled=False, is_logging_enabled=True):
    ...
    csv_head_prices = "\"name\";\"series\";\"instance_name\";\"offer_name\";\"tier\";\"os\";\"category\";\"cores\";\"ram_gb\";\"disk_size_gb\";\"has_paygo\";\"has_spot\";\"is_in_preview\";\"is_vcpu\";\"is_constrained_core\";\"is_base_vm\";\"region\";\"region_name\";\"country\";\"country_name\";\"geographic\";\"geographic_name\";\"price_available\";\"price_per_hour\";\"price_per_month\";\"price_per_hour_one_year_reserved\";\"price_per_month_one_year_reserved\";\"price_per_hour_three_year_reserved\";\"price_per_month_three_year_reserved\";\"price_per_hour_one_year_savings\";\"price_per_month_one_year_savings\";\"price_per_hour_three_year_savings\";\"price_per_month_three_year_savings\";\"price_per_hour_spot\";\"price_per_month_spot\""
    csv_head_prices_currencies = "\"currency\";\"currency_name\";\"currency_info\";\"currency_symbol\";\"currency_conversion\";\"currency_conversion_onprem\";\"currency_conversion_modern\""
        ...
        with open(csv_prices_output_filename, 'w', encoding='utf-8') as csv_prices_file:
            ...
            with alive_bar(max_bar, title="Export prices record to CSV", disable=is_silent_enabled) as bar:
                for price_item in prices_list_records:
                    ...
                    csv_prices_record = f"\"{str_name}\";\"{str_series}\";\"{str_instance_name}\";\"{str_offer_name}\";\"{str_tier}\";\"{str_os}\";\"{str_category}\";\"{str_cores}\";\"{str_ram_gb}\";\"{str_disk_size_gb}\";\"{str_has_paygo}\";\"{str_has_spot}\";\"{str_is_in_preview}\";\"{str_is_vcpu}\";\"{str_is_constrained_core}\";\"{str_is_base_vm}\";\"{str_region}\";\"{str_region_name}\";\"{str_country}\";\"{str_country_name}\";\"{str_geographic}\";\"{str_geographic_name}\";\"{str_price_available}\";\"{str_price_per_hour}\";\"{str_price_per_month}\";\"{str_price_per_hour_one_year_reserved}\";\"{str_price_per_month_one_year_reserved}\";\"{str_price_per_hour_three_year_reserved}\";\"{str_price_per_month_three_year_reserved}\";\"{str_price_per_hour_one_year_savings}\";\"{str_price_per_month_one_year_savings}\";\"{str_price_per_hour_three_year_savings}\";\"{str_price_per_month_three_year_savings}\";\"{str_price_per_hour_spot}\";\"{str_price_per_month_spot}\"\n"
