...
def az_export_prices_list_to_sqlite(sqlite_prices_output_filename, prices_list={}, is_overwrite_sqlite=False, is_add_currency_sqlite=True, is_silent_enabled=False, is_logging_enabled=True):
    ...
    sqlit_create_table_prices += "name TEXT NOT NULL,"
    sqlit_create_table_prices += "series TEXT NOT NULL,"
    sqlit_create_table_prices += "instance_name TEXT NOT NULL,"
    sqlit_create_table_prices += "offer_name TEXT NOT NULL,"
    sqlit_create_table_prices += "tier TEXT NOT NULL,"
    sqlit_create_table_prices += "os TEXT NOT NULL,"
    sqlit_create_table_prices += "category TEXT NOT NULL,"
    sqlit_create_table_prices += "cores REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "ram_gb REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "disk_size_gb REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "has_paygo NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "has_spot NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "is_in_preview NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "is_vcpu NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "is_constrained_core NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "is_base_vm NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "region TEXT NOT NULL,"
    sqlit_create_table_prices += "region_name TEXT NOT NULL,"
    sqlit_create_table_prices += "country TEXT NOT NULL,"
    sqlit_create_table_prices += "country_name TEXT NOT NULL,"
    sqlit_create_table_prices += "geographic TEXT NOT NULL,"
    sqlit_create_table_prices += "geographic_name TEXT NOT NULL,"
    sqlit_create_table_prices += "price_available NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "price_hybridbenefit NUMERIC NOT NULL DEFAULT '0',"
    sqlit_create_table_prices += "price_per_hour REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_one_year_reserved REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_one_year_reserved REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_three_year_reserved REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_three_year_reserved REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_one_year_savings REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_one_year_savings REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_three_year_savings REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_three_year_savings REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_spot REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_spot REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_one_year_reserved_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_one_year_reserved_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_three_year_reserved_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_three_year_reserved_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_one_year_savings_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_one_year_savings_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_three_year_savings_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_three_year_savings_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_hour_spot_hybridbenefit REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices += "price_per_month_spot_hybridbenefit REAL NOT NULL DEFAULT '0.0')"
    ...
    sqlit_create_table_prices_currency += "currency TEXT NOT NULL,"
    sqlit_create_table_prices_currency += "currency_info TEXT NOT NULL,"
    sqlit_create_table_prices_currency += "currency_name TEXT NOT NULL,"
    sqlit_create_table_prices_currency += "currency_symbol TEXT NOT NULL,"
    sqlit_create_table_prices_currency += "currency_conversion REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices_currency += "currency_conversion_onprem REAL NOT NULL DEFAULT '0.0',"
    sqlit_create_table_prices_currency += "currency_conversion_modern REAL NOT NULL DEFAULT '0.0')"
